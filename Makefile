...
midi-light-organ: midi-light-organ.o midi-listener.o $(RGB_LIBRARY)
	g++ -o midi-light-organ midi-light-organ.o midi-listener.o $(RGB_LDFLAGS) $(MAGICK_LDFLAGS) $(LDFLAGS) -lasound
